...
int main(int argc, char **argv) {
    ...
    printf("\n****************************************************\n");
    printf("Step 1: Initialize the double hashing table!\n");
    double_hash_table_init(XIP_VXT_TABLE_SIZE);
    printf("****************************************************\n\n");

    printf("\n****************************************************\n");
    printf("Step 2: Insert %d items into the double hashing table!\n", ele_num);
    
    for (i = 0; i < ele_num; i++) {
        //printf("insert key = %u\n", elements[i]);
        DHT_insert(elements[i], i);
    }
    ...
    printf("\n****************************************************\n");
    printf("Step 3: check the double hashing table!\n");

#if 1
    for (i = 0; i < ele_num; i++) {
        if (DHT_lookup(elements[i]) != i) {
